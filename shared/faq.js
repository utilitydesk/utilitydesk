/* UtilityDesk V6.68 — delegated FAQ + shared output recovery runtime. */
(function () {
  'use strict';
  function init() {
    ...
    recoverOutputs(document);new MutationObserver(function(muts){muts.forEach(function(m){m.addedNodes.forEach(function(n){if(n.nodeType===1)recoverOutputs(n)})})}).observe(document.body,{childList:true,subtree:true});
  }
